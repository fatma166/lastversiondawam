...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('trans.showbrancheval')); ?>
                   ...
                   <!-- Page Header -->
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title"><?php echo e(__('trans.showbrancheval')); ?></h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/dashboard')); ?>"><?php echo e(__('trans.Dashboard')); ?></a></li>
                                    <li class="breadcrumb-item active"><?php echo e(__('trans.showbrancheval')); ?></li>
                                </ul>
                            </div>
    					   	...
    					   	<div class="col-3">  
                                ...
                                <select class="select branchcharts" name="branch">
                                   ...
                                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    								...
    								<label class="focus-label"><?php echo e(__('trans.branch')); ?></label>
    							</div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dawam/public_html/manger_subdomain/resources/views/evaluations/branch_charts.blade.php ENDPATH**/ ?>
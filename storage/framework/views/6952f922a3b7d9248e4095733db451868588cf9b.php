...
<div class="page-wrapper">
                ...
                <div class="row">
                   ...
                   <?php if(isset( $leave_annual)): ?>
                       ...
                       <?php endif; ?>
                        ...
                        <?php endif; ?>
                        <!-- /Maternity Leave -->
                        <?php if(isset($leave_hours)): ?>
                        <!-- hours Leave -->
                        <div class="card leave-box" id="leave_hours">
                            <div class="card-body">
                                <div class="h3 card-title with-switch">
                                    <?php echo e(__('trans.Hours')); ?>

                                    <div class="onoffswitch">
                                        <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" switch_status="hours" id="switch_hours" <?php if($leave_hours->status=='active'): ?><?php echo e('checked="checked"'); ?><?php endif; ?> >
                                ...
                                <div class="leave-item">
                                    <div class="leave-row">
                                        <div class="leave-left">
                                            <div class="input-box">
                                                <div class="form-group">
                                                    <label><?php echo e(__('trans.hours')); ?></label>
                                                    <input type="number" class="form-control"  attr_type="hours" column="num_hours" value="<?php if(isset($leave_hours->num_hours)): ?>  <?php echo e($leave_hours->num_hours); ?> <?php endif; ?>" disabled>
                               ...
                               <!-- <div class="leave-item">
                                    <div class="leave-row">
                                        <div class="leave-left">
                                            <div class="input-box">
                                                <div class="form-group">
                                                    <label><?php echo e(__('trans.times')); ?></label>
                                                   
                                                     <input type="number" class="form-control"  attr_type="hours" column="num_days" value="<?php if(isset($leave_hours->num_days)): ?>  <?php echo e($leave_hours->num_days); ?> <?php endif; ?>" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="leave-right">
        ...
        <!-- /Page Wrapper -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dawam/public_html/manger/resources/views/leave/leave_setting.blade.php ENDPATH**/ ?>
             ...
             <table class="table table-striped custom-table " id="table_search">
                <thead>
                    ...
                    <th><?php echo e(__('trans.excepition holiday')); ?></th>
                     <th><?php echo e(__('trans.leave request')); ?></th>
                     <th><?php echo e(__('trans.leave hours request count')); ?></th>
...
<tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">      
                                                   ...
                                                   <a href="<?php echo e(url('admin/userReport/'.$month['employeeId'])); ?>"  class="employee_detail">
                                                        <h2 class="table-avatar">
                                            ...
                                            <td>
                                                ...
                                                <?php if(isset($month['leave_request_count'])): ?> <?php echo e($month['leave_request_count']); ?> <?php endif; ?>
                                                </h2>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <?php if(isset($month['leave_request_hours_count'])): ?> <?php echo e($month['leave_request_hours_count']); ?> <?php endif; ?>
                                                </h2>
                                            </td>
                                            <td>
                                                <h2 class="table-avatar">
...
<?php /**PATH /home/dawam/public_html/manger/resources/views/reports/month_ajax.blade.php ENDPATH**/ ?>
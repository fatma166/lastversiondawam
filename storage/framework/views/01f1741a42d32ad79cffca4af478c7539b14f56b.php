                    ...
                    <li class="submenu">
                            <a href="#" class="noti-dot"><i class="la la-user-plus"></i> <span><?php echo e(__('trans.All Employees')); ?></span> <span class="menu-arrow"></span></a>
                                <ul style="display:none;">
                                      ...
                                      <li>
                                            <a class="<?php echo e(Request::is('admin/employees/employee') ? 'active' : ''); ?>"
                                                href="<?php echo e(url('admin/employees/employee')); ?>"><?php echo e(__('trans.Total_ Employees')); ?></a>
                                      </li> 
                                      <?php if($roles['name']=="developer"||$roles['name']=="accountant"||$roles['name']=="super_admin"||$roles['name']=="admin"): ?>
                                      <li>
                                            <a class="<?php echo e(Request::is('admin/employees/manger') ? 'active' : ''); ?>"
                                                href="<?php echo e(url('admin/employees/manger')); ?>"><?php echo e(__('trans.Add Manger')); ?></a>
                                      </li>  
                                      <?php endif; ?>                                                                              
                                </ul>
                     </li>

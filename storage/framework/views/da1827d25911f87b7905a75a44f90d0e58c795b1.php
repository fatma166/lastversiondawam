      ...
      /*  $.ajax(
        ...
        $.ajax({
                ...
                beforeSend: function() { $("#outdoor_data #load").show(); },
                        ...
                        history.pushState('', '',"<?php echo e(url('admin/outdoor')); ?>"+"?employee_name="+employee_name+"&customer_id="+customer_id +"&status="+status+"&date="+date+"&created_by="+created_by+"&branch="+branch+"&visit_type="+visit_type+"&to="+to+"&department"+department+"&page="+page);
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dawam/public_html/manger/resources/views/outdoors/index.blade.php ENDPATH**/ ?>
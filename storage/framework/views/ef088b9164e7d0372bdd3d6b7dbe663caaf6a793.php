 ...
 $(document).ready(function(){
        ...
        <script>
    		...
    		$("#search_track").click(function(){
                ...
                history.pushState('', '',"<?php echo e(url('admin/track')); ?>"+"?employee_name="+employee_name+"&date="+date)
    		/*	$.ajax({
        ...
        var boundsListener = google.maps.event.addListener((map), 'bounds_changed', function(event) {
         ...
         <?php $__env->stopSection(); ?><?php /**PATH /home/dawam/public_html/manger_subdomain/resources/views/track/search.blade.php ENDPATH**/ ?>
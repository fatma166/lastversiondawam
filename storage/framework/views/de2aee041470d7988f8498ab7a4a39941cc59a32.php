							...
							<div class="profile-widget">
								<div class="profile-img">
									<a data-href="<?php echo e(url('admin/branch-edit/'.$branch->id)); ?>" 
                                        branch-id="<?php echo e($branch->id); ?>" data-toggle="modal" data-target="#edit_branch" class="avatar"><img src="assets/img/profiles/avatar-02.jpg" alt=""></a>
								</div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dawam/public_html/manger_subdomain/resources/views/company/branch/branch-list.blade.php ENDPATH**/ ?>
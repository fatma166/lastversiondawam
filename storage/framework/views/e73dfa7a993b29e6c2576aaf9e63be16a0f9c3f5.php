                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-right ml-auto">
                            <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_employee"><i class="fa fa-plus"></i><?php if($type=="employee"): ?><?php echo e(__('trans.Add Employee')); ?><?php else: ?><?php echo e(__('trans.Add Manger')); ?> <?php endif; ?> </a>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="select department" name="department">
                                                <?php if((($roles['name']=="admin")|| (Session::has('company')))&& ($type=="manger")): ?> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <select class="select role" name="role_id">
                                                    ...
                                                    <?php endif; ?> 
                                                    <?php if(!empty($roles_)&& ($type=="manger")): ?> 
                                    ...
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="">
                                                <select class="select role" name="role_id">
                                                   <?php if(($roles['name']=="admin")|| (Session::has('company'))&&($type=="employee")): ?>
                                                    <option value="Null"><?php echo e(__('trans.Employee')); ?></option>
                                                   <?php endif; ?>
                                                    <?php if(!empty($roles_)&& ($type=="manger")): ?> 
                                                        <?php $__currentLoopData = $roles_; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

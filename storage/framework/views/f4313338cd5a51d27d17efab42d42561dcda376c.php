							...
							<div class="profile-widget">
								<div class="profile-img">
									<a  data-href="<?php echo e(url('admin/company-edit/'.$company->id)); ?>"
                                        data-id="<?php echo e($company->id); ?>" data-toggle="modal" data-target="#edit_company" class="avatar"><img src="assets/img/profiles/avatar-02.jpg" alt=""></a>
								</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dawam/public_html/manger_subdomain/resources/views/company/company-list.blade.php ENDPATH**/ ?>
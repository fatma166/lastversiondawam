...
unset($__errorArgs, $__bag); ?>
                            ...
                            <!--target location check -->                             
                             ...
                             <!--outdoor without attend check -->
                                 ...
                                 <div class="col-sm-3">
                                    <label class="d-block"><?php echo e(__('trans.outdoor without attend check')); ?></label>
                                    <div class="leave-inline-form">
                                        <div class="form-check form-check-inline">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dawam/public_html/manger/resources/views/jobs/job-list.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('trans.subscibe_companies')); ?>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="stats-info">
                            <h6><?php echo e(__('trans.Joining')); ?></h6>
                            <h4>12 <span><?php echo e(__('trans.This Month')); ?></span></h4>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="stats-info">
                            <h6><?php echo e(__('trans.Renewal')); ?></h6>
                            <h4>3 <span><?php echo e(__('trans.This Month')); ?></span></h4>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="stats-info">
                            <h6><?php echo e(__('trans.Renewal')); ?></h6>
                            <h4>0 <span><?php echo e(__('trans.Next Month')); ?></span></h4>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="stats-info">
                            <h6><?php echo e(__('trans.Total Companies')); ?></h6>
                            <h4>312</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row filter-row" >
                        <div class="col-sm-6 col-md-2"> 
                          <div class="form-group form-focus ">
                              <!--<select class="company_namew form-control" name="company_name"></select>   -->                         
                                ...
                                <label class="focus-label"><?php echo e(__('trans.Select Company')); ?></label>
                            </div>
                        </div>
                   ...
                   <div class="col-sm-6 col-md-2 col-lg-2 col-xl-2 col-12"> 
                        <div class="form-group form-focus select-focus">
                            <select class="floating" name="status" > 
                                ...
                                <option value="1"> <?php echo e(__('trans.active')); ?> </option>
                                <option value="0"> <?php echo e(__('trans.nonactive')); ?> </option>
                   ...
                   <div class="col-sm-6 col-md-2 col-lg-2 col-xl-2 col-12">  
                        <div class="form-group form-focus" >
                            ...
                            <label class="focus-label"><?php echo e(__('trans.date from')); ?></label>
                        </div>
                    </div>
                   <div class="col-sm-6 col-md-2 col-lg-2 col-xl-2 col-12">  
                        <div class="form-group form-focus">
                   ...
                   <div class="col-sm-6 col-md-2 col-lg-2 col-xl-2 col-12">  
                        <a  class="btn btn-success btn-block" id="search_subscribe_companies"> <?php echo e(__('trans.Search')); ?> </a>  
                   </div>     
                </div>
                </form>
                <!-- /Search Filter -->
                        ...
                        <div class="table-responsive">	
                            <table class="table table-hover custom-table datatable mb-0">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th><?php echo e(__('trans.Company')); ?></th>
                                        <th><?php echo e(__('trans.Plan')); ?></th>
                                        ...
                                        <th><?php echo e(__('trans.Paid Status')); ?></th>
                                        <th><?php echo e(__('trans.Update Plan')); ?></th>
                                        <th><?php echo e(__('trans.Pause-On')); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                 <?php $__currentLoopData = $company_plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$company_plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                ...
                                                <a href="client-profile"><?php echo e($company_plan['title']); ?></a>
                                            </h2>
                                        </td>
                                        <td><?php echo e($company_plan['pay_type']); ?></td>
                                        <td><?php echo e($company_plan['number_user']); ?></td>
                                        <td><?php echo e($company_plan['duration']); ?></td>
                                        <td><?php echo e($company_plan['date_from']); ?></td>
                                        <td><?php echo e($company_plan['date_to']); ?></td>
                                        <td>$<?php echo e($company_plan['price_user']*$company_plan['duration']); ?></td>
                                        <td><span class="badge bg-inverse-success"><?php echo e($company_plan['paid']); ?></span></td>
                                        <td><a class="btn btn-primary btn-sm"  data-href="<?php echo e(url('admin/company_subscribe_show/'.$company_plan['id'])); ?>" data-id="<?php echo e($company_plan['id']); ?>" data-toggle="modal" data-target="#upgrade_plan">Change Plan</a></td>
                                        <td>
                                       
                                            <div class="status-toggle">
                                                <input type="checkbox" subscribe-id="<?php echo e($company_plan['id']); ?>" id="company_status_<?php echo e($company_plan['id']); ?>" class="check company_status" value="<?php echo e($company_plan['status']); ?>" <?php if($company_plan['status']==1): ?><?php echo e('checked'); ?><?php endif; ?>>
                                                <label for="company_status_<?php echo e($company_plan['id']); ?>" class="checktoggle">checkbox</label>
                                            </div>
                                        </td>
                                    </tr>
                                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dawam/public_html/manger_subdomain/resources/views/company/subscribe/subscriptions.blade.php ENDPATH**/ ?>
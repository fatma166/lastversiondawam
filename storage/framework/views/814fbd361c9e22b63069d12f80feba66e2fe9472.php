...
<div class="page-wrapper">
            ...
            <?php endif; ?>
                <!-- /Search Filter -->
                <div id="leave_data">
                   <?php echo $__env->make('leave/search', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
            <!-- /Page Content -->
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?php echo e(route('store-leaves')); ?>"  method="post">
      ...
      /*  $.ajax(
        ...
        $.ajax({
                ...
                beforeSend: function() { $("#leave_data #load").show(); },
                    ...
                    history.pushState('', '',"<?php echo e(url('admin/leaves')); ?>"+"?employee_name="+employee_name+"&from="+from +"&leave_type="+leave_type+"&to="+to+"&department="+department+"&branch="+branch+"&page"+page);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dawam/public_html/manger/resources/views/leave/index.blade.php ENDPATH**/ ?>
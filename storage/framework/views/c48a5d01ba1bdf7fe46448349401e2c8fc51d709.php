                            ...
                            <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                                <div class="profile-widget">
                                   ...
                                   <?php $__currentLoopData = json_decode($attendance->attendances_details); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index =>$details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($count_==$i+1): ?></span> <button style="<?php if($i==1||$i==0): ?>visibility:hidden;<?php endif; ?> " onclick="myFunction(<?php echo e($key_index); ?>)" id="myBtn_<?php echo e($key_index); ?>"><?php echo e(__('trans.Read more')); ?></button> <?php endif; ?>
                                       <?php ++$i; ?> 
...
<?php $__env->stopSection(); ?>  <?php /**PATH /home/dawam/public_html/manger/resources/views/available_employee/search.blade.php ENDPATH**/ ?>
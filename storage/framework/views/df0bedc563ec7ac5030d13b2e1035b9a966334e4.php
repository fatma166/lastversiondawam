                        ...
                        <div class="">
                            ...
                            <form id="register" method="post">
                                ...
                                <div style="overflow: auto;">
                                    <div style="text-align: center;">
                                      <!--  <button class="next-dawam" type="button" id="prevBtn" onclick="nextPrev(-1)"><?php echo e(__('trans.Next')); ?></button>
                                        <button class="prev-dawam" type="button" id="nextBtn" onclick="nextPrev(1)"><?php echo e(__('trans.Previous')); ?></button>
                                   -->
                                       <button class="prev-dawam" type="button" id="prevBtn" onclick="nextPrev(-1)"><?php echo e(__('trans.Previous')); ?></button>
                                    <button class="next-dawam" type="button" id="nextBtn" onclick="nextPrev(1)"><?php echo e(__('trans.Next')); ?></button>
                                    </div>
                                </div>

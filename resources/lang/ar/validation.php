...
return [
  ...
  'joining_date' => 'اتاريخ التعين',
  'email entered before'=>'البريد الإلكتروني موجود مسبقاً',
  'email' => 'الالبريد الالكترونى',
  'phone' => 'رقم الهاتف',
  //add custom shift form
  'break_time' => 'وقت الراحة',
  'date_from' => 'تاريخ البداية',
  'date_to' => 'تاريخ النهاية',
  'time_in_min' => 'ادنى وقت للبدء',
  'time_in' => 'وقت البدء ',
  'time_in_max' => 'اقصى وقت للبدء ',
  'time_out_min' => 'ادنى وقت لاللانتهاء  ',
  'time_out' => 'وقت الانتهاء ',
  'time_out_max' => ' اقصى وقت للانتهاء   ',
],

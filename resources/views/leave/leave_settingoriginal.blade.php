                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="card-body">
                                <div class="h3 card-title with-switch">
                                    ...
                                    <div class="onoffswitch">
                                        <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox"  switch_status="Annual" id="switch_annual" @if($leave_annual->status=='active'){{'checked="checked"'}}@endif>
                        ...
                        <div class="card leave-box" id="leave_paternity">
                            <div class="card-body">
                                <div class="h3 card-title with-switch">
                                    {{__('trans.Paternity')}}  <span class="subtitle">{{__('trans.Assigned to male only')}}</span>
                                    <div class="onoffswitch">
                                        <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" switch_status="Paternity" id="switch_paternity" @if($leave_Paternity->status=='active'){{'checked="checked"'}}@endif >
                                    ...
                                    <div class="leave-row">
                                        <div class="leave-left">
                                            <div class="input-box">
                                                <div class="form-group">
                                                    <label>{{__('trans.Days')}}</label>
                                                    <input type="text" class="form-control"  attr_type="Paternity" column="num_days" value="@if(isset($leave_Paternity->num_days))  {{$leave_Paternity->num_days}} @endif" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="leave-right">
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="{{route('add-custom-leave')}}" method="post">
                               @csrf
                               <div class="form-group">

                                               ...
                                               <?php $i=0; ?>
                                                @foreach($evaluation_keies as $jobsevaluations)
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td>{{$jobsevaluations['target_location']=='1'?'???':'??'}}</td>
    												   <td>
    												    ...
    												    <td class="text-right">
                                                            <div class="dropdown dropdown-action">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="#" data-href="{{url('admin/edit-evaluationjob/'.$jobsevaluations['id'])}}" jobevaluation-id="{{$jobsevaluations['id']}}" data-toggle="modal" data-target="#edit_evaluationjob"><i class="fa fa-pencil m-r-5"></i> {{__('trans.Edit')}}</a>
                                                                     <!--</a><a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_evaluationjob" delete-id="{{$jobsevaluations['id']}}"><i class="fa fa-trash-o m-r-5"></i> {{__('trans.Delete')}}</a>-->
                                                                </div>
                                                            </div>
                                                        </td>
							...
							<div class="modal-body">
                                ...
                                <div class="col-sm-6">
									...
									<div class="submit-section">
										...
										<button  id="jobeval button" class="btn btn-primary evaluation-btn" disabled

                ...
                <div class="page-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto float-right ml-auto">
                            ...
                            <a href="" class="btn add-btn" data-toggle="modal" data-target="#add_plan"><i class="fa fa-plus"></i> {{ __('trans.Add Plan') }}</a>
                    ...
                    <div class="col-lg-10 mx-auto">
                        ...
                        <div class="row justify-content-center mb-4">
                            <div class="col-auto">
                                <nav class="nav btn-group">
                                    <a href="#monthly" class="btn btn-outline-secondary active show" data-toggle="tab">{{__('Monthly Plan')}}</a>
                                    <a href="#annual" class="btn btn-outline-secondary" data-toggle="tab">{{__('Annual Plan')}}</a>
                                </nav>
                            </div>
                        </div>
                        <!-- /Plan Tab -->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade active show" id="monthly">
                                ...
                                @if(isset($plans_month))
                                    @foreach($plans_month as $plan)
                                    ...
                                    <div class="col-md-4" >
                                        <div class="card pricing-box">
                                            <div class="card-body d-flex flex-column">
                                                <div class="mb-4">
                                                    <h3>{{$plan->name}}</h3>
                                                    <span class="display-4">{{$plan->price_user}}</span>
                                                    <h3>{{__('trans.userpermonth')}}</h3>
                                                </div>
                                                <?php  $descriptions=explode(',',$plan->descriptions); ?>
                                              
                                                    <ul>
                                                        <li><i class="fa fa-check"></i> <b>{{__('trans.users')}}{{$plan->number_users}}</b></li>
                                                        @if(isset($descriptions))
                                                        @foreach($descriptions as $descrip)
                                                            <li><i class="fa fa-check"></i> <b>{{$descrip}}</b></li>
                                                    
                                                        @endforeach
                                                        @endif
                                                    </ul>
                                                          
                                                <a  href=""  class="btn btn-lg btn-outline-secondary  mt-auto"  data-href="{{ url('admin/plan-edit/'.$plan->id) }}" plan-id="{{$plan->id}}"  type="month" data-toggle="modal" data-target="#edit_plan"> {{__('trans.Edit')}}</a>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                                    ...
                                    <div class="col-md-4" >
                                        <div class="card pricing-box">
                                            <div class="card-body d-flex flex-column">
                                               ...
                                               <a  class="btn btn-lg btn-outline-secondary  mt-auto" data-href="{{ url('admin/plan-edit/'.$plan->id) }}" plan-id="{{$plan->id}}" type="year" data-toggle="modal" data-target="#edit_plan"> {{__('trans.Edit')}}</a>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">{{__('trans.Add Plan')}}</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post" action="{{route('subscribe-store-plan',$subdomain)}}">
                                @csrf
                                <div class="row">
                                      <div class="col-sm-6">
                                            <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label class="col-form-label">{{__('trans.Price User')}}</label>
          ...
          <!--  end Add plan Modal-->  
            ...
            <div id="edit_plan" class="modal custom-modal fade" role="dialog">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">{{__('trans.edit Plan')}}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>

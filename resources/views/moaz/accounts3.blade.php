                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-auto float-right ml-auto">
                        ...
                        <a class="btn add-btn" data-toggle="modal"
                            data-target="#add_cat"><i class="fa fa-plus"></i>إضافة قسم</a>
										...
										<table class="table table-striped mb-0"  id="table_search">
											...
											<tbody>
												<tr>
                                                    ...
                                                    <td> <a  data-toggle="modal" data-target="#delete_cat"><i class="fa fa-trash-o m-r-5"></i> {{__('trans.Delete')}}</a>                                   
                                                         / 
                                                         <a href="javascript:void(0);" data-toggle="modal"  data-target="#edit_cat">{{__('trans.Edit')}}</a></span>
                                                    </td>
												</tr>
											</tbody>
										</table>
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="form-header">
                            <h3>{{__('trans.Delete cat')}}</h3>
                            <p>هل تريد حذف القسم ؟</p>
                        </div>

...
@section('title')
    {{__('trans.ShowJob_ChartEvalaution')}}
@endsection
                   ...
                   <!-- Page Header -->
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title">{{ __('trans.ShowJob_ChartEvalaution') }}</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard') }}">{{ __('trans.Dashboard') }}</a></li>
                                    <li class="breadcrumb-item active">{{ __('trans.ShowJob_ChartEvalaution') }}</li>
                                </ul>
                            </div>
    					   	...
    					   	<div class="col-3">  
                                ...
                                <select class="select jobscharts" name="jobs">
                                   ...
                                   @endforeach
    								...
    								<label class="focus-label">{{__('trans.jobs')}}</label>
    							</div>

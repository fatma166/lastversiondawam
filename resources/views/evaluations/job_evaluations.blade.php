            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                          ...
                          <h4 class="eval_title">{{__('trans.JobEvaluationEdit')}}</h4>
                           ...
                           @csrf
                             <input type="hidden" name="jobEval_id" />
                           	...
                           	<div class="table-responsive m-t-15">
                                ...
                                <button class="btn btn-primary editjobeval_btn" type="edit">{{__('trans.Save')}}</button>
					...
					<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form method="post" action="{{route('sotre_job_evaluation',$subdomain)}}">
                                 ...
                                 @csrf
                                    ...
                                    @if(!empty($job))
                                        ...
                                        @else
                                          <hr />
                                                <h5 style="color: yellow;">{{__('trans.No Evaluation Elements')}}</h5>
                                              <a href="{{route('evaluations',$subdomain)}}"   class="btn btn-outline-success" 
                                                         ><h5 style="color: yellow;">{{__('trans.Click Here')}}</h5></a>

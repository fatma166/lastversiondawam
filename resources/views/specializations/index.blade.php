                   ...
                   <!-- Page Header -->
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title"> {{__('trans.Specializations')}}</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard') }}">{{ __('trans.Dashboard') }}</a></li>
                                    <li class="breadcrumb-item active"> {{__('trans.Specializations')}}</li>
                                </ul>
                            </div>
                            ...
                            <div class="col-auto float-right ml-auto">
                                ...
                                <a href="#" class="btn add-btn" id="" data-toggle="modal" data-target="#add_specialization" 
                                 class="add_specialization"  data-href="{{ url('admin/showspecialization/') }}"><i class="fa fa-plus"></i> {{ __('trans.add specialization') }}</a>  
									...
									<div class="table-responsive">
										<table class="table table-striped custom-table " id="table_search" >
											<thead>
												<tr>
							    	                 <th>#</th>
                                                     <th>{{__('trans.Specializations')}}</th>
                                               ...
                                               <?php $i=0; ?>
                                                @foreach($specialization as $specialization)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <a class="btn btn-outline-success" href="#" data-href="{{ url('admin/editspecialization/'.$specialization->id) }}" specialization-id="{{$specialization->id}}"  data-toggle="modal" data-target="#edit_specialization">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">{{__('trans.add specialization')}}</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post" action="{{route('addspecializations',$subdomain)}}">
                                @csrf
                                <div class="row">
           ...
           <!-- add_specialization Modal -->
            ...
            <div id="edit_specialization" class="modal custom-modal fade" role="dialog">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">{{__('trans.Edit Specialization')}}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="modal-btn delete-action">
                                <div class="row">
                                    <div class="col-6">
                                        <a href="javascript:void(0);" class="btn btn-primary specialization-btn-del">{{__('trans.Delete')}}</a>
                                    </div>
                                    <div class="col-6">
...
<!-- /Delete task -->
 ...
 {{-- $("#add_specialization,#edit_task button").click(function(e){ --}}
@endsection
 @section('script')
<script>

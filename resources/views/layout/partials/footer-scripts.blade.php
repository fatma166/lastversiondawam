	...
	$("#edit_evaluationjob").on('show.bs.modal', function(event) 
    {
		...
		$("#edit_employee button,#add_employee button").click(function(e){
			...
			if($(this).attr('type')=="edit"){
              ...
              department=($("#edit_employee form select[name='department']" ).val())=="all"?"NULL":$("#edit_employee form select[name='department']" ).val();
                data11={name:$( "#edit_employee form input[name*='name']" ).val(),
                    ...
                    branch:$("#edit_employee form select[name='branch']" ).val(),//$( "#edit_employee select[name='branch']" ).val()
			...
			$.ajax({
				...
				$.each(data, function( index,employee){
					...
					$( "select[name='job_id']" ).val(employee.job_id);
                     ...
                     console.log($("#edit_employee select[name='department']").val());
                     role=(employee.role_id==null)?"Null":employee.role_id;

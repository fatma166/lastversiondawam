                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto float-right ml-auto">
                                ...
                                <button class="btn add-btn" id="evlauation_val" data-toggle="modal" data-target="#add_evaluation" 
                                 ...
                                 <button class="btn add-btn job_evaluation_add"  data-toggle="modal" data-target="#job_evaluation">
                                <i class="fa fa-plus"></i> {{ __('trans.job_evaluation') }}</button>    
                                 ...
                                 @csrf
									<div class="row">
										<div class="col-sm-6 col-md-2"> 
                    							<div class="form-group form-focus select-focus">
                                                	...
                                                	<select class="select floating employee" name="job_evalutionsid"> 
									...
									<div class="table-responsive m-t-15">
										<table class="table table-striped custom-table">
											...
											<tbody>
                                           	@foreach($evaluation2 as $evaluation)
												<tr>
													<td>{{$evaluation->title}}</td>
                                                   
                                                     <td><input type="checkbox"   name="evaluation_id[{{$evaluation->id}}]"  value="{{$evaluation->id}}"/></td>
             	                                     <td class="text-center"> 
                                                       <input  type="number"   name="degree[{{$evaluation->id}}]" class="form-control" style="width:100px" />

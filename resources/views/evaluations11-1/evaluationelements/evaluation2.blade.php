                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto float-right ml-auto">
                                ...
                                <a class="btn add-btn evlauation_valadation" data-toggle="modal"
                        ...
                        <form method="post" action="{{route('store-Evaluation')}}">
                         @csrf
                            <div class="row">
                              ...
                              <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Total Evaluation Eelements : </label>
                                        <input type="text" name="get_total_evaluation"/>
                                        
                                    </div>
                                     <div class="form-group">
                                        <label>Reminer Evaluation Eelements : </label>
                                      
                                         <input type="text" name="reminder_evaluation"/>
                                    </div>
                                </div>
...
<script>
 /*evaluation  elements */
             //onshow add mdoula
             $('.evlauation_valadation').click(function(){
                 $.ajax
                ({
                 ...
                 url:"get-totalEvaluation",
                  success: function(data) {
                      if(data>=100)
                      {
                        alert('نسبة التقييم مكتملة يرجي تعديل نسب العناصر ')
                      }
                      else
                      {
                ...
                ({
                 ...
                 url:"get-totalEvaluation",
                  success: function(data) {
                      ...
                      $("#add_evaluation form input[name='get_total_evaluation']").val(data);
                      $("#add_evaluation form input[name='reminder_evaluation']").val(100- data);
